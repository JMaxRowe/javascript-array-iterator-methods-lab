...
veryOldInventors = inventors.filter(inventor => (inventor.year < 1600) && (inventor.year > 1499))
...
sortedByBirthYear = inventors.sort(inventor => inventor.year)
...
isAdultPresent = devs.some(dev => dev.year < (2025-18))
// Check your work:
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every(dev => dev.year < (2025-19))
// Check your work:
...
totalYearsLived = inventors.reduce((lifespan, inventor) =>{
    const life = inventor.passed - inventor.year;
    return lifespan + life;
}, 0)
...
//I DID HAVE TO LOOK UP HOW TO DO THE LEVEL UP QUESTIONS AND STILL DON'T QUITE GET IT, 
// I KNOW YOU SAID WE WOULD GO OVER REDUCE() LATER BUT I THOUGHT I'D GIVE IT A GO